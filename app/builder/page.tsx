...
export default function BuilderPage() {
  ...
  return (
    <div className="flex flex-col flex-1 bg-surface min-h-[calc(100vh-4rem)]">
      ...
      <div className="bg-white border-b border-border px-3 sm:px-6 py-2.5 sticky top-16 z-30 shadow-2xs">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            <input
              ...
              onChange={(e) => {
                // local title change handled if needed
              }}
              className="font-bold text-xs sm:text-sm text-primary-text bg-transparent hover:bg-surface px-2 py-1 rounded border border-transparent hover:border-border focus:border-primary focus:bg-white focus:outline-none max-w-[200px] truncate"
              placeholder="Untitled Resume"
            />

            {/* Template Selector Dropdown (All 6 Templates) */}
            <div className="flex items-center gap-1.5 text-xs bg-surface border border-border rounded-lg px-2.5 py-1">
              <span className="text-secondary-text font-medium hidden sm:inline">Template:</span>
              <select
          ...
          {/* Right: Explicit Sample Loader & Action Tools */}
      ...
      {/* Demonstration Sample Data Active Banner */}
      {isSampleLoaded && (
      ...
      {/* Main Workspace Layout (Desktop 3 Regions) */}
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-5 flex-1 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          {/* Region 1: Left Navigation & Completeness (Desktop 3 cols ~ 260px) */}
          ...
          {/* Region 2: Center Editor Form (Desktop 5 cols ~ 560px) */}
          ...
          {/* Region 3: Right Live A4 Preview (Desktop 4 cols ~ 550-620px) */}
          <div className={`lg:col-span-4 sticky top-28 ${mobileTab === 'editor' ? 'hidden lg:block' : 'block'}`}>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs">
          <div className="bg-white rounded-2xl border border-border p-6 max-w-sm w-full shadow-2xl space-y-4">
            ...
            <p className="text-xs text-secondary-text leading-relaxed">
              Your current resume will be cleared from the editor.
            </p>
